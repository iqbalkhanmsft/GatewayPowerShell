...
#Then utilizesthe  "Datasources as Admin" API to get each dataset's underlying data sources - specifically those utilizing a gateway.
...
#Since a workspace may have multiple datasets, split these out into individual records.
ForEach($Item in $Workspaces) {
    ...
    #Store values from workspace object, and underlying dataset object.
