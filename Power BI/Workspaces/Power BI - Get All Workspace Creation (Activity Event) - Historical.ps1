...
#DESCRIPTION:
#Returns all Power BI activity log data (specifically workspace creation) from 30 days prior through the day before yesterday.
...
#For the last 30 days through the day before yesterday, get all Power BI activity log data (specifically workspace creation) - extract incrementally, one day at a time.
30..2 |
foreach {
