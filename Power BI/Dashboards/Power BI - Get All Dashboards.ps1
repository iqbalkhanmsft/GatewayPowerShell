...
#DOCUMENTATION: https://docs.microsoft.com/en-us/powershell/module/microsoftpowerbimgmt.reports/get-powerbidashboard?view=powerbi-ps

#DESCRIPTION: Extract all dashboards via PowerShell and service principal.
...
$FileName = $File + "Power BI - All Dashboards.csv"
